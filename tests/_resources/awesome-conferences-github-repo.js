...
const TEST_CASE_1_RESULT = [
  [
    { name: 'Awwwards Conference', url: 'http://conference.awwwards.com', twitter: '@awwwardsNYC', region: 'Global' },
    { name: 'BackboneConf', url: 'http://backboneconf.com/', twitter: '@backboneconf', region: 'Global' },
  ],
  [
    { name: '!!Con', url: 'http://www.bangbangcon.com', twitter: '@bangbangcon', region: 'North American' },
    { name: 'AlterConf', url: 'http://www.alterconf.com/', twitter: '@AlterConf', region: 'North American' },
  ],
  [
    { name: 'Brazil JS Conf', url: 'http://braziljs.com.br/', twitter: '@braziljs', region: 'South American' },
  ],
  [
    { name: 'Arrrrcamp', url: 'http://2015.arrrrcamp.be', twitter: '@arrrrcamp', region: 'European' },
    { name: 'Beyond Tellerrand', url: 'http://beyondtellerrand.com', twitter: '@btconf', region: 'European' },
  ],
  [
    { name: 'CSSConf Asia', url: 'http://cssconf.asia/', twitter: '@CSSconfasia', region: 'Asian' },
    { name: 'Jing JS (京JS)', url: 'http://jsconf.cn', twitter: '@jingjsconf', region: 'Asian' },
  ],
];
